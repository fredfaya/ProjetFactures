...
@pytest.mark.parametrize(
    ...
    [
        (
            "RIB : FR76 3000 3000 3000 3000 3000 300",
        ...
        (
            ...
            "info@fssb.de\nwww.fssb.de",
            [
                "DE05 6928 0035 0841 0148 00",
                "DE05 6928 0035 0841 0148 00",
                "CH20 0028 7287 " "8141 6960 T",
            ],
        ),
        (
            ...
            "1849572-3",
            ["TR80 0020 3000 0184 9572 0000 03"],
        ),
    ],
)
def test_extract_rib_should_return_a_rib_when_given_a_text_with_a_rib(
    input_text, expected_output
):
